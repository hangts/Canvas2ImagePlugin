...
//
  ...
  module.exports = {
    ...
    saveImageDataToLibrary:function(successCallback, failureCallback, canvasId, quality) {
        ...
        if (typeof successCallback != "function") {
            ...
            var imageData = canvas.toDataURL('image/jpeg', Number(quality) || 1).replace(/data:image\/jpeg;base64,/,'');
